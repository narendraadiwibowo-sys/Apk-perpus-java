...
public class Form_Pencarian_Buku extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Form_Pencarian_Buku.class.getName());
    private java.awt.Image bgOriginal;

    public Form_Pencarian_Buku() {
        initComponents();
        // Load gambar asli untuk resize
        bgOriginal = new javax.swing.ImageIcon(getClass().getResource("/images/Form Pencarian Buku.jpg")).getImage();
    ...
    private void initComponents() {
        ...
        bgLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Form Pencarian Buku.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        //</editor-fold>
        java.awt.EventQueue.invokeLater(() -> new Form_Pencarian_Buku().setVisible(true));
    }
