...
public class Dashboard_user extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Dashboard_user.class.getName());
    private java.awt.Image bgOriginal;

    public Dashboard_user() {
        initComponents();
        // Load gambar asli untuk resize
        bgOriginal = new javax.swing.ImageIcon(getClass().getResource("/images/Dashboard User.jpg")).getImage();
    ...
    private void initComponents() {
        ...
        bgLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Dashboard User.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        //</editor-fold>
        java.awt.EventQueue.invokeLater(() -> new Dashboard_user().setVisible(true));
    }
