...
public class Form_Anggota extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Form_Anggota.class.getName());
    private java.awt.Image bgOriginal;

    public Form_Anggota() {
        initComponents();
        // Load gambar asli untuk resize
        bgOriginal = new javax.swing.ImageIcon(getClass().getResource("/images/Form Anggota.jpg")).getImage();
    ...
    private void initComponents() {
        ...
        bgLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Form Anggota.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        //</editor-fold>
        java.awt.EventQueue.invokeLater(() -> new Form_Anggota().setVisible(true));
    }
