...
public class Laporan_buku extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Laporan_buku.class.getName());
    private java.awt.Image bgOriginal;

    public Laporan_buku() {
        initComponents();
        // Load gambar asli untuk resize
        bgOriginal = new javax.swing.ImageIcon(getClass().getResource("/images/Laporan Buku.jpg")).getImage();
    ...
    private void initComponents() {
        ...
        bgLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Laporan Buku.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        //</editor-fold>
        java.awt.EventQueue.invokeLater(() -> new Laporan_buku().setVisible(true));
    }
